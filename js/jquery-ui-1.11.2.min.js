...
(function(e) {
    ...
    function o() {
        e.datepicker._isDisabledDatepicker(
            ...
            (e(this)
                ...
                e(this).addClass("ui-state-hover"), -1 !== this.className.indexOf("ui-datepicker-prev") &&
                e(this).addClass("ui-datepicker-prev-hover"), -1 !== this.className.indexOf("ui-datepicker-next") &&
    ...
    e.extend(n.prototype, {
            ...
            _findPos: function(t) {
                for (
                    var i, s = this._getInst(t), n = this._get(s, "isRTL"); t &&
